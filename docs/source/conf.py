"""Configuration for arxiv-canonical documentation build."""
#!/usr/bin/env python3
# -*- coding: utf-8 -*-
#
# arXiv Canonical Record documentation build configuration file, created by
...
project = 'arXiv Canonical Record'
...
htmlhelp_basename = 'arXiv-Canonical-Docs'
...
latex_documents = [
    (master_doc, 'arXivCanonical.tex',
     'arXiv Canonical Record Documentation',
...
texinfo_documents = [
    (master_doc, 'arXivCanonical',
     'arXiv Canonical Record Documentation',
     author, 'arXivCanonical', 'One line description of project.',
     'Miscellaneous'),
]
