...
from typing import Callable, Iterable, IO, Optional, Tuple, Union
...
class DeferredRequestReader(io.BytesIO):
    def __init__(self, method: Callable[[str], requests.Response],
    ...
    def read(self, size: Optional[int, bool] = -1) -> bytes:
